...
public class PessoaWebController {
    ...
    public PessoaWebController(PessoaService pessoaService) { this.pessoaService = pessoaService; }

    @GetMapping public String index() { return "redirect:/pessoas/listar"; }
    ...
    public String cadastrarPessoa(@Valid @ModelAttribute("pessoa") Pessoa pessoa,
                                  BindingResult result,
                                  RedirectAttributes ra) {
        if (result.hasErrors()) { return "pessoas/form"; }
